...
const BUILTINS = { start, stop, status, goto, back, forward, reload, search, click, type, snapshot, scroll, screenshot, wait, evaluate, upload, select, daemon, hover, getText, getPageInfo, findElements, getReadable, newTab, closeTab, listTabs, switchTab, multiOpen, getCookies, setCookies, setUserAgent, setViewport, waitDomStable, scrollAndCollect, fetchPage, login };
